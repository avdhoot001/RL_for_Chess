...
#     # ---------------------------------------------------------------------
#     def evaluate_board(self, chess_obj: Chess, root_color: int):
#         """Board evaluation from the perspective of root_color."""
#         result = chess_obj.game_result()
#         if result is not None:
#             if result == 0:
#                 return 0
...
#         # Check immediate checkmate (mate in 1 or 2 shortcut)
#         for move in legal_moves:
#             (i, j), (dx, dy), promo = move
#             test_board = chess_obj.copy()
#             test_board.make_move(i, j, dx, dy, promo)
#             if test_board.game_result() is not None:
#                 # Found mate in 1
#                 result = test_board.game_result()
#                 if result == 1:
#                     return 100000 - depth if root_color == 1 else -100000 + depth
#                 elif result == -1:
#                     return -100000 + depth if root_color == 1 else 100000 - depth
...
#         # Try to detect mate-in-1 directly at root
#         for move in legal_moves:
#             (i, j), (dx, dy), promo = move
#             sim_board = chess_obj.copy()
#             sim_board.make_move(i, j, dx, dy, promo)
#             if sim_board.game_result() is not None:
#                 result = sim_board.game_result()
#                 if (result == 1 and chess_obj.turn == 1) or (result == -1 and chess_obj.turn == -1):
#                     return move  # immediate mate in 1
