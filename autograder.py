...
if __name__ == "__main__":
    ...
    if task_no == 0:
        ...
        task_2_score = result_2[test_agent_2.name]["total_wins"] - result_2[rational.name]["total_wins"]
        ...
        task_3_score = result_3[test_agent_3.name]["total_wins"] - result_3[rational.name]["total_wins"]
        ...
        task_score = result[test_agent.name]["total_wins"] - result[(rand if task_no==1 else rational).name]["total_wins"]
